...
async function inicializarPix() {
    try {
        ...
        const valorFormatado = qrCodeData.valor.toFixed(2);
        const codigoPixText = `00020126330014br.gov.bcb.pix0111${qrCodeData.chavePix}520400005303986540${valorFormatado.length}${valorFormatado}5802BR5925${qrCodeData.nomeBeneficiario}6008${qrCodeData.cidade}62070503***${qrCodeData.txId}6304`;
