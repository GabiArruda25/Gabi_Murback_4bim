...
const transporter = nodemailer.createTransport({
  service: 'gmail',
  auth: {
	user: process.env.EMAIL_USER || 'contato.milkmoo@gmail.com',
...
transporter.verify(function(error, success) {
  if (error) {
	...
	console.log('   EMAIL_USER=contato.milkmoo@gmail.com');
...
async function enviarEmailRecuperacao(destinatario, nome, codigo) {
  ...
  const mailOptions = {
	from: {
	      name: '🐄 MilkMoo Franquias',
	      address: process.env.EMAIL_USER || 'noreply@milkmoo.com.br'
	    },
	    to: destinatario,
	    subject: '🔐 Código de Recuperação de Senha - MilkMoo',
    html: `
      <!DOCTYPE html>
      <html lang="pt-BR">
      <head>
      ...
      <body>
        <div class="container">
          <!-- Header -->
	          <div class="header">
	            <h1>🐄 MilkMoo Franquias</h1>
	            <p>Alegria e Sabor em Cada Gole</p>
	          </div>
          ...
          <div class="content">
            ...
            <div class="message">
	              <p>Você solicitou a <strong>recuperação de senha</strong> da sua conta na MilkMoo Franquias.</p>
          ...
          <div class="footer">
            ...
            <div class="copyright">
             	© ${new Date().getFullYear()} MilkMoo Franquias<br>
...
Este é um email automático. Não responda.
	              ...
	              © ${new Date().getFullYear()} MilkMoo Franquias
═══════════════════════════════════════════════════════
    `
  };
